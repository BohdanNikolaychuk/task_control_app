...
router.patch('/dashboards/:dashId/boards/:boardId', BoardsController.changeStatusInTask);
router.put('/dashboards/:dashId/boards/:boardId', BoardsController.changeArchiveStatus);
